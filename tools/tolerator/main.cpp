...
static cl::opt<AnalysisType> analysisType{
    ...
    cl::values(
        clEnumValN(AnalysisType::LOGGING, "log", "Log failures and terminate."),
        clEnumValN(AnalysisType::IGNORING, "ignore",
                   "Ignore failures without values."),
        clEnumValN(AnalysisType::DEFAULTING, "defaults",
                   "Yield default values for failures"),
        clEnumValN(AnalysisType::BYPASSING, "returns",
                   "Returns from functions with failures")),
    cl::init(AnalysisType::LOGGING), cl::cat{toleratorCategory}};

static cl::opt<string> outFile{
    "o", cl::desc{"Filename of the instrumented program"},
    cl::value_desc{"filename"}, cl::init(""), cl::cat{toleratorCategory}};
...
static cl::list<string> libPaths{
    ...
    cl::value_desc{"directory"}, cl::cat{toleratorCategory}};

static cl::list<string> libraries{
    "l", cl::Prefix, cl::desc{"Specify libraries to link against"},
    cl::value_desc{"library prefix"}, cl::cat{toleratorCategory}};

static cl::list<string> extras{
    "e", cl::Prefix, cl::desc{"Specify extra object files to link in"},
    cl::value_desc{"object files"}, cl::cat{toleratorCategory}};
...
static void compile(Module& m, StringRef outputPath) {
  ...
  unique_ptr<TargetMachine> machine(target->createTargetMachine(
      ...
      options, llvm::codegen::getRelocModel(), llvm::NoneType::None, level));
...
static void link(StringRef objectFile, StringRef outputFile) {
  ...
  vector<string> args{clang.get(), opt, "-o", outputFile.str(),
                      objectFile.str()};
...
static void instrument(Module& m, AnalysisType analysisType) {
